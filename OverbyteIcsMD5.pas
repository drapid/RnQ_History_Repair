...
procedure MD5UpdateBuffer(var MD5Context: TMD5Context; Buffer: Pointer; BufSize: Integer); overload;
procedure MD5Final(var Digest: TMD5Digest; var MD5Context: TMD5Context);
procedure MD5ContextClear(var MD5Context : TMD5Context);

function GetMD5(Buffer: Pointer; BufSize: Integer): AnsiString; overload;
